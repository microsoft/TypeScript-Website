...
const flowerLatinName = (flower: Flower) => {
  switch (flower) {
      case Flower.Rose:  return "Rosa rubiginosa"
      case Flower.Rhododendron:  return "Rhododendron ferrugineum"
      case Flower.Violet:  return "Viola reichenbachiana"
      case Flower.Daisy:  return "Bellis perennis"

      default: const _exhaustiveCheck: never = flower
  }
}
