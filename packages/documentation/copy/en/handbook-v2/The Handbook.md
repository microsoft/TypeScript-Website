...
Otherwise, jump to [Basic Types](/docs/handbook/2/basic-types.html) or grab an copy in [Epub](/assets/typescript-handbook.epub) or [PDF](/assets/typescript-handbook.pdf) form.
