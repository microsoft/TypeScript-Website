...
We could also have used a different name for the generic type parameter in the type, so as long as the number of type variables and how the type variables are used line up.
