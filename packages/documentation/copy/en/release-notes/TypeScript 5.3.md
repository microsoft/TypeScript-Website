...
A completely insane feature of JavaScript that undermines the whole concept of instanceof checks is that it is possible to override the behavior of the `instanceof` operator.
