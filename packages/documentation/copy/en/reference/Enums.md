...
A. Do not use const enums at all.
   You can easily [ban const enums](https://github.com/typescript-eslint/typescript-eslint/blob/main/docs/linting/TROUBLESHOOTING.md#how-can-i-ban-specific-language-feature) with the help of a linter.
