...
One effect of this is that it's not possible for TypeScript to concatenate multiple module source files into one output file.
Use a bundler if you need a single JavaScript output file.
