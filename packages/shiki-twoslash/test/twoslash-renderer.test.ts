...
`
  ...
  expect(html).toMatchInlineSnapshot(`
    "<pre class=\\"shiki twoslash lsp\\"><div class='code-container'><code><span style=\\"color: #D4D4D4\\">  function <data-lsp lsp='function f(): {&amp;#13;    x: number;&amp;#13;    y: number;&amp;#13;}'>f</data-lsp>() {</span>
    <span style=\\"color: #D4D4D4\\">    return { <data-lsp lsp='(property) x: number'>x</data-lsp>: 10, <data-lsp lsp='(property) y: number'>y</data-lsp>: 3 };</span>
    <span style=\\"color: #D4D4D4\\">  }</span>
    <span style=\\"color: #D4D4D4\\">  type <data-lsp lsp='type P = {&amp;#13;    x: number;&amp;#13;    y: number;&amp;#13;}'>P</data-lsp> = <data-lsp lsp='type ReturnType&amp;lt;T extends (...args: any) => any> = T extends (...args: any) => infer R ? R : any'>ReturnType</data-lsp>&lt;typeof <data-lsp lsp='function f(): {&amp;#13;    x: number;&amp;#13;    y: number;&amp;#13;}'>f</data-lsp>>;</span>
