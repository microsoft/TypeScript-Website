...
The table of contents is generated by the playground examples package. The Astro
site's asset synchronization step assembles the generated metadata and example
source files into its deployable `js/examples` directory.
