// JavaScript에는 몇몇 객체를 불변으로 선언할 수 있는 몇 가지 방법이 있슴니다.
...
// 값을 바꾸면 TypeScript에서는 에러가 발생하는데,
// 런타임에서 값을 얻기 때문입니다.

helloWorld = "Hi world";

// 왜 불변성을 신경 써야 할까요?
// 많은 부분은 코드의 복잡성을 줄이는 데 있습니다.
// 값이 변하는 대상의 수를 줄일 수 있다면,
// 계속 값을 따라갈 일이 줄어듭니다.

// const를 사용하는 것은 훌륭한 첫 단계지만,
// 객체를 사용할 때는 에러가 발생합니다.
...
// freeze를 사용함으로써
// 객체가 내부적으로 동일하게 유지된다고 믿을 수 있습니다.
