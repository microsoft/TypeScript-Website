...
`--lib`                                        | `string[]`|                                | List of library files to be included in the compilation.<br/>Possible values are:  <br/>► `ES5` <br/>► `ES6` <br/>► `ES2015` <br/>► `ES2016` <br/>► `ES2017` <br/>► `ES2018` <br/>► `ES2019` <br/>► `ES2020` <br/>► `ESNext` <br/>► `DOM` <br/>► `DOM.iterable` <br/>► `ScriptHost` <br/>► `WebWorker` <br/>► `WebWorker.ImportScripts` <br/>► `ES2015.Collection` <br/>► `ES2015.Core` <br/>► `ES2015.Generator` <br/>► `ES2015.Iterable` <br/>► `ES2015.Promise` <br/>► `ES2015.Proxy` <br/>► `ES2015.Reflect` <br/>► `ES2015.Symbol` <br/>► `ES2015.Symbol.Wellknown` <br/>► `ES2016.Array.Include` <br/>► `ES2016.Full` <br/>► `ES2017.Full` <br/>► `ES2017.Intl` <br/>► `ES2017.Object` <br/>► `ES2017.SharedMemory` <br/>► `ES2017.String` <br/>► `ES2017.TypedArrays` <br/>► `ES2018.AsyncGenerator` <br/>► `ES2018.AsyncIterable` <br/>► `ES2018.Full` <br/>► `ES2018.Intl` <br/>► `ES2018.Promise` <br/>► `ES2018.RegExp` <br/>► `ES2019.Array` <br/>► `ES2019.Full` <br/>► `ES2019.Object` <br/>► `ES2019.String` <br/>► `ES2019.Symbol` <br/>► `ES2020.Full` <br/>► `ES2020.String` <br/>► `ES2020.Symbol.Wellknown` <br/>► `ESNext.Array` <br/>► `ESNext.AsyncIterable` <br/>► `ESNext.BigInt` <br/>► `ESNext.Full` <br/>► `ESNext.Intl` <br/>► `ESNext.Symbol <br/><br/> Note: If `--lib` is not specified a default list of libraries are injected. The default libraries injected are:  <br/> ► For `--target ES5`: `DOM,ES5,ScriptHost`<br/>  ► For `--target ES6`: `DOM,ES6,DOM.Iterable,ScriptHost`
