...
`--jsxFragmentFactory`                         | `string`  | `"React.createElement"`        | Specify the JSX fragment factory function to use when targeting react JSX emit, e.g. `React.createElement` or `h`.
