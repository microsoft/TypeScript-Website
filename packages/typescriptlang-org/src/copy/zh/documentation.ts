export const docCopy = {
  ...
  doc_headline: "开始学习",
  doc_headline_ts_for_js_title: "TS 对于 JS",
  doc_headline_ts_for_js_blurb: "针对具有 JavaScript 背景工程师的 TypeScript 概述",
  doc_headline_ts_first_title: "从 TS 开始",
  doc_headline_ts_first_blurb: "针对初学者的 JavaScript 和 TypeScript 的介绍",
  doc_apis_loopback_blurb: "一个高度可扩展的 Node.js 和 TypeScript 框架，用于构建 API 和微服务",
  doc_apis_fastify_blurb: "一个快速、低开销的用于 Node.js 的 Web 框架",
