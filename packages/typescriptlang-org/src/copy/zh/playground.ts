export const playCopy = {
  ...
  play_sidebar_errors_no_errors: "无错误",
  play_sidebar_logs: "日志",
  play_sidebar_logs_no_logs: "无日志",
  play_sidebar_options: "选项",
  play_sidebar_options_restart_required: "需要重新加载",
  play_sidebar_options_disable_ata: "禁用 ATA",
  play_sidebar_options_disable_ata_copy: "禁用获取 require 或 import 的自动类型获取。",
  ...
  play_export_report_issue: "提交 TypeScript 的 Github issue。",
  play_export_copy_md: "复制为 Markdown 格式的 issue 模板",
  play_export_copy_link: "复制为 Markdown 格式的链接",
  play_export_copy_link_preview: "复制为 Markdown 格式的带有预览的链接",
  ...
  play_default_code_sample: `// 欢迎来到 TypeScript 在线演示，
