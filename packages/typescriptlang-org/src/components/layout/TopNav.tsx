...
export const SiteNav = (props: Props) => {
  ...
  useEffect(() => {
    ...
    // Change the wording on the search
    const searchInput = document.getElementById("search-box-top") as HTMLInputElement
      ...
      <div id="top-menu" className="up">
        <div className="left below-small">
          ...
          <a id="home-page-logo" href="/" aria-label="TypeScript Home Page">
            ...
            <Text variant="xLarge" styles={boldStyle} className="hide-small">TypeScript</Text>
          </a>
          ...
          <nav >
            <ul>
              <form className="search top-nav" role="search">
                ...
                <span><input id='search-box-top' type="search" placeholder="Search does not work without JavaScript" disabled /></span>
                <input type="submit" style={{ display :"none" }} />
              </form>

              <li className="nav-item hide-small"><a href="/community"><svg fill="none" height="12" viewBox="0 0 12 12" width="12" xmlns="http://www.w3.org/2000/svg"><circle cx="6" cy="6" fill="#fff" r="6" /></svg></a></li>
