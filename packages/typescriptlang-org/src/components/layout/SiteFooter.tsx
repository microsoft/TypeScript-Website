    ...
    <footer id="site-footer">
      ...
      <section id='community'>
        <article id="logos">
          ...
          <img id='microsoft-logo' width={92} height={19} src={require("../../assets/microsoft-logo.png")} alt="Microsoft Logo" />
          <p>© 2012-2019 Microsoft<br /><a href="https://go.microsoft.com/fwlink/?LinkId=521839">Privacy</a></p>
        </article>
        ...
        <article id="community-links">
          <h3>Community</h3>
          <ul>
            {useTypeScriptLinks.map(page => <li key={page.url}><Link to={page.url}>{page.title}</Link></li>)}
          </ul>
        </article>
