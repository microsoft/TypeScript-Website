    ...
    <div className='headline-diagram'>
      ...
      <div style={{ position: "absolute", left: "50%", bottom: "-8px" }}>
        <a className="next-headline-button" href="#" onClick={next} role="presentation">
          ...
          <div className="next">
            <p>Next</p>
            <p><svg width="11" height="15" viewBox="0 0 11 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 14.5V0.5L10.5 7L0 14.5Z" fill="#08446E" /></svg></p>
          </div>
        </a>
      </div>
    </div >
  ...
  return (
    <div>
      ...
      <Editor title="TypeScript" front code={ts}
        ...
        inline={() =>
          (<>
            <div className="underline-error" style={{ top: "44px", left: "110px", width: "42px" }} />
