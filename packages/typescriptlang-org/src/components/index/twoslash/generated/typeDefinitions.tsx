...
const innerHTML = `<pre class="shiki twoslash"><div class="language-id">tsx</div><div class='code-container'><code><span style="color: #569CD6">import</span><span style="color: #D4D4D4"> <data-lsp lsp='(alias) function express(): core.Express&amp;#13;(alias) namespace express&amp;#13;import express'>express</data-lsp> </span><span style="color: #569CD6">from</span><span style="color: #D4D4D4"> </span><span style="color: #CE9178">"express"</span>
...
<span style="color: #D4D4D4">  <data-lsp lsp='(parameter) res: Response&amp;lt;any>'>res</data-lsp>.<data-lsp lsp='any'>se</data-lsp></span><span style="color: #6A9955">/*** @completions */</span>
<span style="color: #D4D4D4">})</span>

<span style="color: #D4D4D4"><data-lsp lsp='const app: Express'>app</data-lsp>.<data-lsp lsp='(method) Application.listen(port: number, callback?: ((...args: any[]) => void) | undefined): Server (+5 overloads)'>listen</data-lsp>(</span><span style="color: #B5CEA8">3000</span><span style="color: #D4D4D4">)</span></code></div></pre>`

export const TypeDefinitionsExample = () => <div dangerouslySetInnerHTML={{ __html: innerHTML }} />
