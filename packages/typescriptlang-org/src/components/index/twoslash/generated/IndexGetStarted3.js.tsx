...
<div class='twoslash-annotation left' style="top: 4em">
  <svg style='transform: translateX(18) translateY(-3) rotate(44);' width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class='twoslash-annotation right' style="top: 7em">
  <svg style='transform: translateX(1) translateY(2) rotate(-64);' width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
