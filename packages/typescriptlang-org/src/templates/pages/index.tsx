...
import {
  ...
  GitHubBar,
  OSS,
} from "../../components/index/MigrationStories"
...
const QuarterOrHalfRow = (props: { children: any; className?: string }) => (
  <div className={[props.className, "split-row"].join(" ")}>
    {props.children}
  </div>
)
const Row = (props: { children: any; className?: string }) => (
  <div className={[props.className, "row"].join(" ")}>{props.children}</div>
)
const Col = (props: { children: any; className?: string }) => (
  <div className={[props.className, "col1"].join(" ")}>{props.children}</div>
)
  ...
  return (
    ...
    >
      <div id="index">
        ...
        >
          Welcome to our new website! Find out what's new{" "}
          <a href="https://devblogs.microsoft.com/typescript/announcing-the-new-typescript-website">
            in the TypeScript Blog
          </a>
        </div>
        <Section color="grey" className="hide-small">
          <div className="call-to-action">
            <Link target="_blank" className="flat-button" to="/play/">
              {i("index_cta_play")}
            </Link>
            <a className="flat-button" href="#installation">
              {i("index_cta_install")}
            </a>
          </div>
        </Section>
        <Section color="white">
          ...
          <Row>
            <Col key="what is js">
              ...
              <div>
                {i("index_what_is_js_copy", { p: chunk => <p>{chunk}</p> })}
              </div>
            </Col>
            <Col key="you can trust typescipt">
              ...
              <div>
                ...
                <p>
                  {i("index_trust_copy_b", {
                    p: chunk => <p>{chunk}</p>,
                    babel: chunk => (
                      <a key={1} href="https://babeljs.io/" target="_blank">
                        {chunk}
                      </a>
                    ),
                  })}
            ...
            <Col key="TS improves JS">
              ...
              <div>
                {i("index_gradual_copy", { p: chunk => <p>{chunk}</p> })}
              </div>
            </Col>
          </Row>
        </Section>
        ...
        <Section color="blue">
          <Row>
            ...
            <Col key="tools description">
              ...
              <div>
                {i("index_tools_copy", {
                  ...
                  atom: chunk => (
                    <a key={3} href="https://atom.io/" target="_blank">
                      {chunk}
                    </a>
                  ),
                  nova: chunk => (
                    <a key={4} href="https://panic.com/nova/" target="_blank">
                      {chunk}
                    </a>
                  ),
                  subl: chunk => (
                  ...
                  emacs: chunk => (
                    <a
                      key={6}
                      href="https://github.com/ananthakumaran/tide/#readme"
                      target="_blank"
                    >
                      {chunk}
                    </a>
                  ...
                  vim: chunk => (
                    <a
                      key={7}
                      href="https://www.vimfromscratch.com/articles/setting-up-vim-for-typescript/"
                      target="_blank"
                    >
                      {chunk}
                    </a>
                  ...
                  eclipse: chunk => (
                    <a
                      key={9}
                      href="https://github.com/eclipse/wildwebdeveloper/"
                      target="_blank"
                    >
                      {chunk}
                    </a>
            ...
            <Col key="why trust ts">
              ...
              <div>
                {i("index_standards_copy", { p: chunk => <p>{chunk}</p> })}
              </div>
            </Col>
          </Row>
        </Section>
          ...
          <Row key="ts videos">
            <Col>
              ...
              <ul id="videos">
                <li
                  ...
                  data-img={withPrefix("/images/index/ts-conf-keynote.jpg")}
                >
                  <a
                    href="https://www.youtube.com/watch?v=jmPZztKIFf4"
                    target="_blank"
                  >
                    <p>
                      TSConf Keynote: 2019
                      <br />
                      <span>By Anders Hejlsberg</span>
                    </p>
                  </a>
                </li>
                <li
                  className="video"
                  data-img={withPrefix("/images/index/what-is-new-ts.jpg")}
                >
                  <a
                    href="https://www.youtube.com/watch?v=Au-rrY0afe4"
                    target="_blank"
                  >
                    <p>
                      What’s new in TypeScript?
                      <br />
                      <span>by Daniel Rosenwasser</span>
                    </p>
                  </a>
                </li>
                <li
                  className="video"
                  data-img={withPrefix("/images/index/ts-at-scale.jpg")}
                >
                  <a
                    href="https://www.youtube.com/watch?v=P-J9Eg7hJwE"
                    target="_blank"
                  >
                    <p>
                      Adopting TypeScript at Scale
                      <br />
                      <span>By Brie Bunge</span>
                    </p>
                  </a>
                </li>
                <li
                  className="video"
                  data-img={withPrefix("/images/index/wrong-ts.jpg")}
                >
                  <a
                    href="https://www.youtube.com/watch?v=AQOEZVG2WY0"
                    target="_blank"
                  >
                    <p>
                      Why I Was Wrong About TypeScript
                      <br />
                      <span>By TJ VanToll</span>
                    </p>
                  </a>
                </li>
              </ul>
            ...
            <Col2>
              ...
              >
                <img
                  width="100%"
                  src={withPrefix("/images/index/ts-conf-keynote.jpg")}
                  alt="Preview thumbnail for video"
                />
              </a>
            </Col2>
          </Row>
        ...
        <Section color="white">
          ...
          <QuarterOrHalfRow key="call to actions">
            <GreyButton
              href="/docs/handbook"
              title={i("index_started_handbook")}
              blurb={i("index_started_handbook_blurb")}
              first
              customClass="white-theme"
            />
            <GreyButton
              href="/docs/bootstrap"
              title={i("index_started_docs")}
              blurb={i("index_started_docs_blurb")}
              customClass="white-theme"
            />
            <GreyButton
              href="/community"
              title={i("index_started_community")}
              blurb={i("index_started_community_blurb")}
              customClass="white-theme"
            />
            <GreyButton
              href="/tools"
              title={i("index_started_tooling")}
              blurb={i("index_started_tooling_blurb")}
              customClass="white-theme"
            />
          </QuarterOrHalfRow>
...
const setupVideosSection = () => {
  ...
  for (let index = 0; index < videosUL.children.length; index++) {
    ...
    element.onmouseover = () => {
      document
        .querySelectorAll("#videos li.active")
      ...
      a.getElementsByTagName("img").item(0)!.src = element.getAttribute(
        "data-img"
      )!
