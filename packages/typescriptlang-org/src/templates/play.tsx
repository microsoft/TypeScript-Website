...
const Play: React.FC<Props> = props => {
    ...
    getLoaderScript.onload = () => {
      ...
      re(
        ...
        async (
          ...
          playground: typeof import("typescript-playground")
        ) => {
          ...
          container.style.height = `${height -
            Math.round(container.getClientRects()[0].top) -
            18}px`
  ...
  return (
    <Layout
      disableBetaNotification
      title={i("head_playground_title")}
      description={i("head_playground_description")}
      lang={props.pageContext.lang}
        ...
        <ul className="nav">
              ...
              <div className="info" id="config-container">
                ...
                <div id="compiler-dropdowns">
                  <label className="select">
                    ...
                    <span className="compiler-flag-blurb">
                      {i("play_config_language_blurb")}
                    </span>
                  </label>
                </div>
              </div>
          ...
          <li className="dropdown">
            ...
            <ul className="examples-dropdown" id="examples">
              ...
              <RenderExamples
                ...
                examples={props.pageContext.examplesTOC}
          ...
          <li className="dropdown">
            <a
              ...
              aria-expanded="false"
            >
              {i("play_subnav_whatsnew")} <span className="caret"></span>
            </a>
                ...
                <li className="dropdown">
                  ...
                  <ul className="dropdown-menu">
                    <li>
                      <a
                        href="#"
                        onClick={() => playground.exporter.reportIssue()}
                      >
                        {i("play_export_report_issue")}
                      </a>
                    </li>
                    ...
                    <li>
                      <a
                        href="#"
                        onClick={() =>
                          playground.exporter.copyAsMarkdownIssue()
                        }
                      >
                    ...
                    <li>
                      <a
                        href="#"
                        onClick={() => playground.exporter.copyForChat()}
                      >
                    ...
                    <li>
                      ...
                      <a
                        href="#"
                        onClick={() =>
                          playground.exporter.copyForChatWithPreview()
                        }
                      >
