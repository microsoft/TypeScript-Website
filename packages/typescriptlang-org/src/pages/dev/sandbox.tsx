...
const Index: React.FC<Props> = props => {
  useEffect(() => {
    ...
    getLoaderScript.onload = () => {
      ...
      re.config({
        paths: {
          vs: "https://tswebinfra-static-web-temp-geh2cke5fmbadkda.z01.azurefd.net/cdn/4.0.5/monaco/min/vs",
...
<html lang="en">
  ...
  <script>
    ...
    getLoaderScript.onload = () => {
      ...
      // https://tswebinfra-static-web-temp-geh2cke5fmbadkda.z01.azurefd.net/indexes/releases.json
      //
      require.config({
        paths: {
          vs: 'https://tswebinfra-static-web-temp-geh2cke5fmbadkda.z01.azurefd.net/cdn/4.0.5/monaco/min/vs',
