...
const remarkShiki = async function (
  ...
  // I'm not wild on this, passing shiki settings back into itself is giving
  // a compiler errro
  const anySettings = shikiSettings as any
  const highlighter = await createShikiHighlighter(anySettings)
